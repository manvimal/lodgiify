                      ...
                      foreach($vehicleowners as $vehicleowner){ 
                          ...
                          ?>
                           ...
                           <tr class="booking">
                             ...
                             <td> <?php if (count($vehicleowner->id) > 0){  ?> <a href="" class=""> Update</a>  <?php } ?>  <a href="<?php echo $deleteLink; ?>" onclick="return confirm_alert(this);" class="deleteBooking" >Delete</a></td>
