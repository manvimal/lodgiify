              ...
              <?php
                if(!empty($bookingsDone)){
                    foreach($bookingsDone as $booking){
                      $deleteLink =  "/adminRoombooking/delete?id=". $booking->id;
                    ?>
                         <tr class="job">
                           <td> <img src="upload/<?php echo $booking->building->image  ?>" class="imageSize"/></td>
                            ...
                            ?>
                             <th><a href="<?php echo $deleteLink; ?>" target="_blank" class="btnLogin adminDeleteRoomBooking">Delete Booking</a></td></th>
